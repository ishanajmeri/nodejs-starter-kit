...
const NavLinkAdminWithI18n = translate('faq')(({ t }: { t: TranslateFunction }) => (
...
const LoadableFaqAdmin = loadable(() => import('./containers/FaqsAdminPanel.web'), {
  fallback: <PageLoading />
});
...
export default new ClientModule({
  route: [
    ...
    <Route role={['admin']} exact path="/edit-faq/:id" component={LoadableFaqEdit} />,
